...
if __name__ == '__main__':
    ...
    for i in range(10000):
        ...
        print('目标点:\t' ,dest_p)
        swipe_time = int(math.sqrt((man_p[0] - dest_p[0])**2 + (man_p[1] - dest_p[1])**2) * 1.363)
        os.system('adb shell input swipe 500 500 500 500 ' + str(swipe_time))
        time.sleep(2)
